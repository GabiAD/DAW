<%@ Page Title="" Language="C#" MasterPageFile="~/Layouts/ContentLayout.master" AutoEventWireup="true" CodeFile="SearchResult.aspx.cs" Inherits="Pages_Content_Home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContent" runat="Server">
    ...
    <h3>
        <asp:Label ID="SearchText" runat="server" Text="Results"></asp:Label>
    </h3>
